...
namespace crow
{
    ...
    {
    public:
        Server(Handler* handler, uint16_t port, const std::string& server_name, std::tuple<Middlewares...>* middlewares = nullptr, uint16_t concurrency = 1, typename Adaptor::context* adaptor_ctx = nullptr)
